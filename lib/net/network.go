...
func goTCPPing(ctx context.Context, hostname string, port int, count int, timeout, interval time.Duration) (avgRTT time.Duration, lossPercentage float64, err error) {
	// set default
	avgRTT = 0
	lossPercentage = 100
